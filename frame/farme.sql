...
( '胡艳Silvia','/creatframe/frame/public/img/zjt_img/zjtdesign3.png','
                            ...
                            将手工艺继续传承下去
                        '),
( '江云Alice','/creatframe/frame/public/img/zjt_img/zjtdesign3.png','丰富的想象、创新能力和前瞻性是必不可少的，这是设计师与工程师的一大区别。工程设计采用计算法或类比法，工作的性质主要是改进、完善而非创新；造型设计则非常讲究原创和独创性'),
( '戴斯Darcie','/creatframe/frame/public/img/zjt_img/zjtdesign3.png','新设计师要不断磨练自己，经得起考验。在这个磨练的过程中我们更多的是要找准自己的定位和长处，必须要对自己苛刻要求，才能更好地提高自己'),
( '张紫萱ailsa','/creatframe/frame/public/img/zjt_img/zjtdesign3.png',' 夕阳从窗外透进来。他的影子长长地映在地板上。脸上的镜片也被阳光晕染得熠熠生辉。就这么温暖,这么宁静。时间似乎凝固了,他审视着自己的作品');
